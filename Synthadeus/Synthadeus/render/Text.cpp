...
void Text::render(ID2D1HwndRenderTarget * renderTarget, ID2D1SolidColorBrush ** colorPalette, IDWriteTextFormat** fontPalette)
{
	...
	renderTarget->DrawText(temporaryStringBuffer, strLength, fontPalette[font],
		D2D1::RectF(point1[0], point1[1], point2[0], point2[1]), colorPalette[color]);
}
